...
class ActivityContainerView: UIView {
    ...
    @IBOutlet
    fileprivate var progressGradientImageView: UIImageView!
        
    @IBOutlet fileprivate weak var titleLabel: UILabel!
    
    @IBOutlet
    fileprivate weak var currentProgressLabel: UILabel!
    
    @IBOutlet
    fileprivate weak var goalLabel: UILabel!
    
    @IBOutlet
    fileprivate weak var containerGradientView: UIView!
    ...
    func flipView(_ activity: Activity) {
        ...
        let transform :CATransform3D = CATransform3DMakeRotation(CGFloat(Double.pi), 0, 1, 0) // rotate around Y
    ...
    fileprivate func configureViewsBeforeFlip(_ activity: Activity) {
