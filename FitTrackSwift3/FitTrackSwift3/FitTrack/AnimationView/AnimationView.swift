...
open class AnimationView: UIView {
    ...
    open var animationFirstPhaseDidFinish: ((Void) -> Void)?
    open var animationDidFinish: ((Void) -> Void)?
    ...
    // MARK - Public methods
    open func configureSubviews(_ activitiesCount: Int, activities: [Activity]) {
